...
public class ExempleFigures
{
    public static void main (String[] args)
    {
        ...
        System.out.println("Volume = " + triangle.volume()); // Attention !
        System.out.println("");
        ...
        System.out.println("Volume = " + carre.volume()); // Attention !
        System.out.println("");
        ...
        System.out.println("Volume = " + rectangle.volume()); // Attention !
        System.out.println("");
        ...
        System.out.println("Volume = " + cercle.volume()); // Attention !
        System.out.println("");
